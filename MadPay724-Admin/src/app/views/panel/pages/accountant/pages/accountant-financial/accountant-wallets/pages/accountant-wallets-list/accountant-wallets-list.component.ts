...
@Component({
  selector: 'app-accountant-wallets-list',
  templateUrl: './accountant-wallets-list.component.html',
  styleUrls: ['./accountant-wallets-list.component.css']
})
export class AccountantWalletsListComponent implements OnInit, OnDestroy {
